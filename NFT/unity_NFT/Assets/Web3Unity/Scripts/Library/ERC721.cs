...
public class ERC721
{
    ...
    public static async Task<int> Total(string _chain, string _network, string _contract, string _rpc="")
    {
    ...
    public static async Task<string> OwnedList(string _chain, string _network, string _contract, string owner, string _rpc="")
    {
        string method = "ownedTokenList";
        string[] obj = {owner};
        string args = JsonConvert.SerializeObject(obj);
        string response = await EVM.Call(_chain, _network, _contract, abi, method, args, _rpc);
        return response; 
    ...
    public static async Task<string> TransferTo(string _contract,string _from, string _to, string _tokenId)
    {
        string method = "safeTransferFrom";
        string[] obj = { _from, _to, _tokenId};
        string args = JsonConvert.SerializeObject(obj);
        // value in wei
        string value = "0";
        string gasLimit = "";
        try {
            string response = await Web3GL.SendContract(method, abi, _contract, args, value, gasLimit);
            return response;
        } catch {            
            throw;
        } 
    ...
    public static async Task<string> MintTo(string _contract,string _from, string _metadaUri)
    {
        string method = "mintNFT";
        string[] obj = { _from, _metadaUri};
        string args = JsonConvert.SerializeObject(obj);
        // value in wei
        string value = "0";
        string gasLimit = "";
